      ...
      <main className="page__main page__main--login">
        <div className="page__login-container container">
          <section className="login">
            ...
            <form className="login__form form" onSubmit={submitHandler} action="#" method="post">
              ...
              <div className="login__input-wrapper form__input-wrapper">
                ...
                <input ref={passwordRef} className="login__input form__input" type="password" name="password" placeholder="Password" data-testid='passwordElement' required />
              </div>
